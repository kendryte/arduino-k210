...
typedef struct {
  ...
  u16_t fh_ix_offset;
#endif
} __attribute(( aligned(8) )) spiffs_config;
...
#endif
} __attribute(( aligned(8) )) spiffs_stat;
...
typedef struct{
  ...
  int entry;
} __attribute(( aligned(8) )) spiffs_DIR;
...
} __attribute(( aligned(8) )) spiffs_ix_map;
