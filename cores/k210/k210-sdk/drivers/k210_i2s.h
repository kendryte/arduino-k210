...
struct _i2s_send_data_t {
    dmac_channel_number_t tx_channel;
    uint32_t *tx_buf;
    size_t tx_len;
};

struct _i2s_recv_data_t {
...
{
    /// @brief wait dma idle before transmit
    bool wait_dma_idle;
    /// @brief wait dma done after transmit
    bool wait_dma_done;

    i2s_transmit_t mode;

    union {
        struct _i2s_send_data_t send;
        struct _i2s_recv_data_t recv;
    };
} i2s_data_t;
