...
{
    TEST_ASSERT_EQUAL(0, listDir(SPIFFS, "/", 0));
}

void testwriteFile(void)
{
    TEST_ASSERT_EQUAL(0, writeFile(SPIFFS, "/hello.txt", "Hello "));
}

void testappendFile(void)
{
    TEST_ASSERT_EQUAL(0, appendFile(SPIFFS, "/hello.txt", "World!\r\n"));
}

void testreadFile(void)
{
    TEST_ASSERT_EQUAL(0, readFile(SPIFFS, "/hello.txt"));
}

void testrenameFile(void)
{
    TEST_ASSERT_EQUAL(0, renameFile(SPIFFS, "/hello.txt", "/foo.txt"));
    TEST_ASSERT_EQUAL(0, readFile(SPIFFS, "/foo.txt"));
    TEST_ASSERT_EQUAL(0, deleteFile(SPIFFS, "/foo.txt"));
}

void testtestFileIO(void)
{
    TEST_ASSERT_EQUAL(0, testFileIO(SPIFFS, "/test.txt"));
    TEST_ASSERT_EQUAL(0, deleteFile(SPIFFS, "/test.txt"));
}
