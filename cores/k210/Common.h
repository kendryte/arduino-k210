...
#define interrupts() rt_exit_critical()
#define noInterrupts() rt_enter_critical()

// or
// #define interrupts() rt_base_t _lvl = rt_hw_interrupt_disable()
// #define noInterrupts() rt_hw_interrupt_enable(_lvl)

#define clockCyclesPerMicrosecond() ( (long int)(sysctl_clock_get_freq(SYSCTL_CLOCK_CPU) / 1000000) )
