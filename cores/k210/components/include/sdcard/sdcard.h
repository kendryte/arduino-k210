...
typedef struct spisd_interface_s {
    void (*init)(int8_t sck, int8_t miso, int8_t mosi, int8_t cs);
...
extern const spisd_interface_t soft_spi_interface;
extern const spisd_interface_t hard_spi_interface;
